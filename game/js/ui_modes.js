...
var BuildSnowTowerMode = function() {
  this.cost = 500;
  this.tower = SnowTower;
  this.name = function() {
    return "BuildSnowTowerMode";
  };
};
BuildSnowTowerMode.prototype = new BuildTowerMode();
...
var build_snow_tower = function() {
  attempt_to_enter_ui_mode(new BuildSnowTowerMode());
};
...
var build_superlaser_tower = function() {
...
var BuildsniperTowerMode = function() {
  this.cost = 125;
  this.tower = sniperTower;
  this.name = function() {
    return "BuildsniperTowerMode";
  }
};
BuildsniperTowerMode.prototype = new BuildTowerMode();




var build_sniper_tower = function() {
  attempt_to_enter_ui_mode(new BuildsniperTowerMode());
}


var BuilddevTowerMode = function() {
  this.cost = 125;
  this.tower = devTower;
  this.name = function() {
    return "BuilddevTowerMode";
  }
};
BuilddevTowerMode.prototype = new BuildTowerMode();
...
var build_dev_tower = function() {
  attempt_to_enter_ui_mode(new BuilddevTowerMode());
}
