...
var default_set = function() {
	...
	set.grid_cache_reset_all_values_for_key = function(key) {
		...
		// colors
	set.bg_colors = {
		neutral: color(149, 165, 166),
		positive: color(39, 174, 96),
		negative: color(192, 57, 43)
	};
	set.bg_color = color(149, 165, 166);
	set.grid_color = color(149, 165, 166);
	set.entrance_color = color(142, 68, 173);
	set.exit_color = color(243, 156, 18);
	set.killzone_color = color(231, 76, 60, 0.7);
	set.creep_color = color(52, 73, 94);
	// rendering groups
	...
	set.state = undefined;
	// game values
	set.creep_variety = "Normal Blobs";
	set.creep_size = 10;
	set.creep_hp = 10;
	set.creep_value = 9;
	set.creep_speed = 50;
...
var fetch_ui_widgets = function() {
	...
	w.creep_speed = document.getElementById("creep_speed");
	...
	w.framerate = document.getElementById("framerate");
	// tower widgets
