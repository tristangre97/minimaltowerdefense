...
var StrongMixin = function(creep) {
  creep.color = color(192, 57, 43);
  creep.size = creep.size * 1.5;
  creep.hp = Math.floor(creep.hp * 1.5);
...
var QuickMixin = function(creep) {
  ...
  creep.color = color(241, 196, 15);
  creep.speed = creep.speed * 1.5;
  creep.hp = Math.floor(creep.hp * .50);
...
var BossMixin = function(creep) {
  ...
  creep.color = color(142, 68, 173);
   creep.speed = creep.speed * .5;
  creep.size = creep.size * 2.3;
  creep.hp = Math.floor(creep.hp * 10);
  creep.value = Math.floor(creep.value * 20);
  return creep;
}

var MABMixin = function(creep) {
  creep.creep_type = "MAB " + creep.creep_type;
  creep.color = color(44,62,80);
  creep.speed = creep.speed * .1;
  creep.size = creep.size * 5.5;
  creep.hp = Math.floor(creep.hp * 100);
  creep.value = Math.floor(creep.value * 120);
  return creep;
}
...
var Creep = function(wave) {
  ...
  c.hp = Math.floor(SET.creep_hp * Math.pow(1.21,wave));
